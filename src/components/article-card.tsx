  ...
  return (
    <Card className="overflow-hidden border border-blue-gray-100 dark:border-blue-gray-800 shadow-md rounded-xl flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        {article.publication && (
          <p className="text-xs font-bold uppercase tracking-widest text-blue-gray-500 dark:text-blue-gray-400 mb-1.5">
            {article.publication}
          </p>
        )}
        ...
        {article.coverage && (
          <p className="text-sm italic text-blue-gray-500 dark:text-blue-gray-400 mb-3 border-t border-blue-gray-50 dark:border-blue-gray-800 pt-3">
            {article.coverage}
          </p>
        )}
        <a
